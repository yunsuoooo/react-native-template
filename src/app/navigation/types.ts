...
// 화면별 route 타입 별칭
export type WebViewScreenRouteProp = RouteProp<RootStackParamList, typeof ROUTES.WEBVIEW>;
export type HomeScreenRouteProp = RouteProp<RootStackParamList, typeof ROUTES.HOME>;
